...
### Elaticseach query DSL


### Architecture

# three type of url to visualization 
# why I chose elastic search - familiar, has abilities for aggregation and storing metrics, basically for it's aggs over time abilities. could have also chosen prom, but this is much easier for me to setup locally and in dev purpose
